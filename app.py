...
st.markdown('<div class="main-title">📈 Payout Calculator</div>', unsafe_allow_html=True)
st.markdown('<div class="subtitle">Prop Firm Profits • by Stoic Capital</div>', unsafe_allow_html=True)
